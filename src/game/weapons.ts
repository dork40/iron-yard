...
export type WeaponSpec = { id: WeaponId; name: string; automatic: boolean; magazine: number; reserve: number; damage: number; headshot: number; fireMs: number; reloadMs: number; recoil: number; spread: number };
export const weapons: Record<WeaponId, WeaponSpec> = {
  rifle: { id: "rifle", name: "MESA RIFLE", automatic: true, magazine: 30, reserve: 90, damage: 25, headshot: 72, fireMs: 95, reloadMs: 1750, recoil: .025, spread: .009 },
  pistol: { id: "pistol", name: "RANGER PISTOL", automatic: false, magazine: 12, reserve: 48, damage: 42, headshot: 96, fireMs: 260, reloadMs: 1250, recoil: .045, spread: .004 },
};
